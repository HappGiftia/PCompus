class Settings {
    ...
    _mergeUrlParameters() {
        const t = window.location.search, e = decodeURIComponent(t), i = new URLSearchParams(e),
    ...
    _onOptionClick(t) {
        t.preventDefault();
        const e = t.currentTarget, i = e.dataset.value, s = e.dataset.parent;
        this.updateAttribute(s, i)
    }

    _setVisibility() {
        this.settings.showSettings || (document.getElementById("settings") && document.getElementById("settings").classList.add("d-none"), document.getElementById("settingsButton") && document.getElementById("settingsButton").classList.add("d-none"))
    }
