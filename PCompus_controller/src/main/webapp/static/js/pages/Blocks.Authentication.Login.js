/**
 * @Author: Happ
 * @Date: 2022-03-28 09:35:50
 * @LastEditTime: 2022-03-28 10:09:09
 * @LastEditors: Happ
 * @Description:
 * @FilePath: \metronic.bootstrap\media\js\app.js
...
var App = (function () {
    ...
    var handleFixedSidebarHoverable = function () {
        ...
        $('.page-sidebar')
            ...
            .on('mouseleave', function () {
                ...
                if (
                    body.hasClass('page-sidebar-hover-on') === false ||
                    body.hasClass('page-sidebar-fixed') === false ||
                    $(this).hasClass('page-sidebar-hovering')
                ) {
                    return;
                ...
                $(this).animate(
                    ...
                    function () {
                        $('body')
                            .addClass('page-sidebar-closed')
                            .removeClass('page-sidebar-hover-on');
                        $(this).removeClass('page-sidebar-hovering');
                    }
                );
            });
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('click', '.sidebar-toggler', function (e) {
            ...
            if (
                (body.hasClass('page-sidebar-hover-on') && body.hasClass('page-sidebar-fixed')) ||
    ...
    var handlePortletTools = function () {
        ...
        jQuery('body').on(
            'click',
            '.portlet .tools .collapse, .portlet .tools .expand',
            function (e) {
                e.preventDefault();
    ...
    var handleTabs = function () {
        ...
        fixTabHeight(
            '.nav.nav-tabs.tabs-left > li.active > a[data-toggle="tab"], .nav.nav-tabs.tabs-right > li.active > a[data-toggle="tab"]'
        );
    ...
    var handleTooltips = function () {
        if (App.isTouchDevice()) {
            // if touch device, some tooltips can be skipped in order to not conflict with click events
    ...
    var handleTheme = function () {
        ...
        $('.layout-option, .header-option, .sidebar-option, .footer-option', panel).change(
            setLayout
        );
    };
